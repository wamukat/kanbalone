...
新規チケット作成ダイアログ右上の import アイコンから、remote issue を取り込みます。
...
panel には対応済み provider がすべて表示されます。

- credential が設定された provider は選択できます
- credential が未設定の provider は表示されたまま disabled になります
